...
import { Sparkles, Target, Grid3x3, Flame, Database, Layout, Maximize2, Eye, Briefcase } from 'lucide-react';
...
export function DirectionSelector() {
  const directions = [
    ...
    },
    {
      id: 'workbench',
      path: '/workbench',
      title: 'Focused Workbench Mode',
      description: 'Evidence workbench for retained evidence, comparison, and replay. Comparison outcome shows matched/differed/blocked dimensions. Replay lineage provides visual timeline of runs. Observation envelope captures state. Evidence bundle tracks scenario, run, observation, comparison, and witness. Actions: export, retain, widen, handoff.',
      icon: Briefcase,
      color: 'from-[#b84532] to-[#c88d2e]',
      featured: true,
    },
    {
      id: 'architecture',
