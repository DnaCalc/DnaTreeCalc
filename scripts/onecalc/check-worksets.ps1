# PARKED (dtc-tsc.1 / D5 consolidation): this script targets the archived
# standalone DnaOneCalc repo layout (its own .beads workspace + a docs/ workset
# register). After consolidation the OneCalc worksets live under docs/onecalc/
# and this repo has no live OneCalc .beads workspace. Left unmodified on purpose;
# do not run as-is. Rewire only if the OneCalc workset/beads process is revived.
