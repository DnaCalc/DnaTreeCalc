...
pub use workspace::{
    ...
    DefinedNamesProjection, DependencyDescriptorProjection, DependencyEdgeProjection,
    ...
    FormulaBindPreviewProjection, GridAuthoredCellProjection, GridAuthoredKindProjection,
    GridCellProjection, GridCellRefProjection, GridEditabilityProjection,
    GridEntryDiagnosticProjection, GridEntryOutcomeProjection, GridMergedOverlayDescriptor,
    GridOverlayBundle, GridOverlayRect, GridProjection, GridRectProjection,
