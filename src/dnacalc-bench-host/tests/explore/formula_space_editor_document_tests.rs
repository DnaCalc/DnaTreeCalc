use dnacalc_bench_host::adapters::oxfml::{
    EditorAnalysisStage, FormulaEditRequest, FormulaEditResult, OxfmlHostSession,
    OxfmlHostSessionError,
};
use dnacalc_bench_host::app::intents::ApplyFormulaEditIntent;
use dnacalc_bench_host::domain::ids::FormulaSpaceId;
use dnacalc_bench_host::services::editor_session::EditorSessionService;
use dnacalc_bench_host::state::{FormulaSpaceCollectionState, FormulaSpaceState};
...
struct ExploreBridge {
    document: dnacalc_bench_host::adapters::oxfml::EditorDocument,
}
...
fn ex_03_formula_edit_intent_preserves_raw_cell_entry_path_for_direct_values() {
    ...
    EditorSessionService::handle_formula_edit_intent(
        ...
        ApplyFormulaEditIntent {
            ...
            trace_mode: dnacalc_bench_host::adapters::oxfml::TraceModeRequest::ValueOnly,
        },
    )
