...
- `ValueBoard` consumes that projection directly for table highlighting, keyboard table-cell navigation, selected-cell summaries, and a unified active-selection strip. It does not derive table semantics from formula text or re-resolve structured references.
