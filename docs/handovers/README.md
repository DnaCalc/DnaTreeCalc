...
- `HANDOVER_OXFML_constant_input.md` — adopt OxFml's §2.1A cell-entry classification on a host-reference formula channel (constant vs. formula by leading `=`). Engine prereq §6 item 11.
